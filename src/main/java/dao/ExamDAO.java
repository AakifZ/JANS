...
public class ExamDAO {
    ...
    final static String Exam_BY_ID = "Select course.course_ID,course.course_name,course.course_description,course.professor_ID from course, course_enrollment Where course.course_ID = course_enrollment.course_ID and student_ID = ?;";
