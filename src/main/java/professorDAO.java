...
public class professorDAO {
    ...
    public boolean checkLogin(int ID, String password) throws SQLException {
        ResultSet rs = null;
        try {
            String query = "select * from professorlogins where ID = ? and password = ?;";
    ...
    public boolean checkLogin(String email, String password) throws SQLException {
        ResultSet rs = null;
        try {
            String query = "select * from professorlogins where email = ? and password = ?";
            PreparedStatement ps = JDBC2.connection.prepareStatement(query);
    ...
    public void insertProfessor(Professor prof) {
        try {
            ...
            ps.setString(4, prof.email);
            ps.setString(5,prof.phone);
            ps.setInt(6,prof.admin);
            ps.executeUpdate();
        }catch (Exception e) {
            e.printStackTrace();
        }
